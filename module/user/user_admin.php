			...
			<div class="col-md-10">
				<div class="row" style=''>
					<div class="col-md-8" style="">
						...
						?>
							<a class="btn btn-success" style="font-weight:bold;" href='<?php echo $_SESSION['DOCUMENT_ROOT_DIR']; ?>/module/user/user_edit.php'><span class="glyphicon glyphicon-plus"></span> Benutzer hinzufügen</a>
						<?php
						}
						?>
					</div>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td><a href='<?php echo $_SESSION['DOCUMENT_ROOT_DIR']; ?>/module/user/user_edit.php?u=<?php echo $user['uID']; ?>'><?php echo $user['name']; ?></a></td>
										<td><a href='<?php echo $_SESSION['DOCUMENT_ROOT_DIR']; ?>/module/user/user_edit.php?u=<?php echo $user['uID']; ?>'><?php echo $user['vname']; ?></a></td>
