...
?>
<div class="col-md-10"><div  class="alert alert-success" style="text-align:center; padding:50px;"><h2 style="padding:0; margin:0">Die Registrierung war erfolgreich!</h2> Sie können sich nun mit Ihrem Benuezernamen und Passwort anmelden</div></div>
<?php
}else{
?>
<div class="col-md-10">
			...
			<div class="col-md-12">
				...
				<div class="form-group">
					<select class="form-control" id="geschlecht" name="geschlecht" required>
						...
						<?php if($userInfo['geschlecht']=="k"){$selected="selected";}else{$selected="";}?>
