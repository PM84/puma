<div class="">
	...
	<br><a style='margin:0 15px;' href="/module/user/PasswortReset.php">Passwort vergessen?</a>
	<br><a style='margin:0 15px;' href="/module/user/user_registration.php">Noch keinen Account?</a>
</div>
