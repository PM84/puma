...
switch($bInfoRow['bTypID']){
	case 1:
		include($_SERVER['DOCUMENT_ROOT'].$_SESSION['DOCUMENT_ROOT_DIR']."/module/mod_bausteine/show_kontrollfrage_ausw.php");
		break;

	case 2:
		include($_SERVER['DOCUMENT_ROOT'].$_SESSION['DOCUMENT_ROOT_DIR']."/module/mod_bausteine/show_wordcloud_ausw.php");
		break;

	case 3:
		include($_SERVER['DOCUMENT_ROOT'].$_SESSION['DOCUMENT_ROOT_DIR']."/module/mod_bausteine/show_abstimmung_ausw.php");
		break;
	...
	case 8: // Aussagen ordnen
 		echo "TEST";
		include($_SERVER['DOCUMENT_ROOT'].$_SESSION['DOCUMENT_ROOT_DIR']."/module/mod_bausteine/show_order_statements_ausw.php");
		break;
}