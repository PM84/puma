...
switch($bInfoRow['bTypID']){
	case 1:
		include($_SERVER['DOCUMENT_ROOT']."/module/mod_bausteine/show_kontrollfrage_loe.php");
		break;

	case 2:
		include($_SERVER['DOCUMENT_ROOT']."/module/mod_bausteine/show_wordcloud_loe.php");
		break;

	case 3:
		include($_SERVER['DOCUMENT_ROOT']."/module/mod_bausteine/show_abstimmung_loe.php");
		break;
...
// 		echo "TEST";
		include($_SERVER['DOCUMENT_ROOT']."/module/mod_bausteine/show_order_statements_loe.php");
		break;
}