...
// 	echo $query;
	...
	// var_dump($_POST);
	if($_POST['saveBtn']==1){
		echo "<script>window.location = '/module/mod_videoanalyse/show_abgabe_uebersicht.php';</script>";
	}
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="row" style='margin-top:10px; text-align:center; background-color:lightgray; padding:10px; border-radius: 10px;'>
						<div class="col-md-1">
							<a href='/module/mod_videoanalyse/show_abgabe_uebersicht.php' class='btn btn-success'>zurück</a>
						</div>
