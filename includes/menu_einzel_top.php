...
if(isset($_SESSION['uID']) && isset($_SESSION['kursID']) && Check_if_kurs_edit_allowed($_SESSION['kursID'],$_SESSION['uID'])==1){
	...
	<ul class="dropdown-menu" style="left:auto; right:20px; padding:15px;">
		...
		<li>
			<div class="checkbox">
<!--				<a class="btn btn-default" href="/module/mod_preasentation/show_einzel_auswertung.php">Auswertung dieser Folie zeigen</a>//-->
				<?php $FolieInfo=getFolieInfo(intval($_GET['f'])); if($FolieInfo['modID']==1){$_SESSION['last_shown_page']=$_SERVER["REQUEST_URI"];  ?>
