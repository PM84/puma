...
function start () {
  ...
  getElement("ip3a",text05);                               // Erklärender Text (Verbraucherwiderstand)
  ...
  getElement("cb1b",text06);                               // Erklärender Text (Spannung angeben)
  cb2 = getElement("cb2a");                                // Optionsfeld (Stromstärke angeben)
  cb2.checked = false;                                     // Optionsfeld zunächst nicht ausgewählt
  getElement("cb2b",text07);                               // Erklärender Text (Stromstärke angeben)
