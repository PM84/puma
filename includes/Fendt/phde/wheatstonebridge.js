...
function reactionButton1 () {
  ...
  input(false);                                            // Eingabe, Berechnungen, neu zeichnen                                           
...
function reactionMove (u, v) {
  ...
  input(true);                                             // Eingabe, Berechnungen, neu zeichnen
  }
...
function enableInputFields (a) {
  ip1.disabled = !a;                                       // Eingabefeld Vergleichswiderstand
  ip2.disabled = !a;                                       // Eingabefeld Schiebewiderstand
  ip3.disabled = !a;                                       // Eingabefeld Spannung
  ip4.disabled = !a;                                       // Eingabefeld Messgerätwiderstand
  }
